...
public class MainDataFile {
    ...
    public void insertRow(ArrayList<Object> key, long rowID) throws IOException, MiniDBException {
        ...
        rowID2position.insertPair(new ArrayList<>(List.of(rowID)), position);
        elementCount += 1;
        file.write(buffer);
    }

    public void deleteRow(long rowID) throws IOException, MiniDBException {
        long position = rowID2position.search(new ArrayList<>(List.of(rowID))).get(0);
        ...
        rowID2position.deletePair(new ArrayList<>(List.of(rowID)), position);
        elementCount -= 1;
    }
